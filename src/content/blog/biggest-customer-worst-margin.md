---
title: "Your biggest customer might be your worst margin. Here's how to check in one weekend."
description: "Most SMEs have one gross margin on paper and five in real life. A straightforward spreadsheet exercise will tell you which customers and products actually make you money — and which ones you're subsidising."
category: "Pricing"
publishedAt: 2026-04-04T09:00:00
readTime: 9
featured: false
draft: false
...
1. **A list of every invoice you've raised in the last 12 months**, with customer name, date, and amount. Most accounting software (Xero, QuickBooks, Sage) exports this in two clicks.
2. **A list of your direct costs that scale with delivery** — typically: delivery staff time, subcontractor fees, materials, per-client licences, shipping. NOT rent, insurance, marketing, or director salaries. Those are fixed overhead and get allocated differently.
3. **A spreadsheet**. Excel or Google Sheets. That's it.
...
I've built this analysis hundreds of times. If you'd like the Excel template I use with C8 clients — pre-structured, with contribution margin formulas built in — [you can grab it for free](/#magnet). Takes about 20 minutes to drop your data in and see the results.
