---
title: "Before you hire: the one model that tells you if you can actually afford it"
description: "A salary is only a third of the real cost of a new hire. National insurance, pension, equipment and ramp-up time add up fast. Here's the simple model I build for clients before they sign a job offer."
category: "Hiring"
publishedAt: 2026-03-22T09:00:00
readTime: 5
featured: false
draft: false
---
...
1. Base salary
2. Multiplier for employer costs (default 1.3)
3. Ramp profile in months (default: 25% / 50% / 75% / 100%)
4. Expected revenue contribution per month once fully ramped
5. Your current monthly cash surplus (revenue minus fixed costs minus director drawings)

**Outputs:**

1. **Month-by-month cash impact** for the next 18 months. Shows exactly where your runway dips during the ramp period.
2. **Break-even month** — when the hire stops costing more than they contribute.
...
If you want the template I use for this — pre-structured with the ramp profile and the runway impact view already built — [grab it for free](/#magnet). It's the same model that lives inside every Clarity-tier engagement with C8.
